...
Pod::Spec.new do |s|
  s.name             = 'InnoHubSDK'
  s.version          = '1.0.0'
  s.summary          = 'A short description of InnoHubSDK.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source_files = ['InnoHubSDK/Classes/**/*.{swift,xib,h,m}']
  ...
  s.vendored_frameworks = ['InnoHubSDK/Classes/InnoHubSDK.framework']
