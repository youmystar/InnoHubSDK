...
#ifndef INNOHUBSDK_SWIFT_H
#define INNOHUBSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="InnoHubSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class CBPeripheral;
@class NSNumber;
SWIFT_CLASS_NAMED("BluetoothManager")
@interface BluetoothManager : NSObject <CBCentralManagerDelegate, CBPeripheralDelegate>
@property (nonatomic, strong) CBCentralManager * _Nullable centralManager;
@property (nonatomic, copy) NSDictionary<NSUUID *, ZZPeripheral *> * _Nullable allPeripherals;
@property (nonatomic, strong) ZZPeripheral * _Nullable curPeripheral;
@property (nonatomic, copy) NSArray<CBService *> * _Nonnull services;
@property (nonatomic, weak) id <BluetoothManagerDelegate> _Nullable delegate;
@property (nonatomic, copy) NSArray<CBCharacteristic *> * _Nonnull readArray;
@property (nonatomic, strong) CBCharacteristic * _Nullable write;
@property (nonatomic, strong) CBCharacteristic * _Nullable write1;
@property (nonatomic, copy) NSString * _Nonnull eigenvalue;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) BluetoothManager * _Nullable shared;)
+ (BluetoothManager * _Nullable)shared SWIFT_WARN_UNUSED_RESULT;
+ (void)setShared:(BluetoothManager * _Nullable)value;
+ (BluetoothManager * _Nullable)resetAndCreateNewInstance SWIFT_WARN_UNUSED_RESULT;
- (void)reset;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)scanWithServices:(NSArray<CBUUID *> * _Nullable)serviceUUIDs;
- (void)startScanWithCbUUid:(NSString * _Nullable)cbUUid;
- (void)stopScan;
- (void)connectPeripheralWithPeripheral:(ZZPeripheral * _Nonnull)peripheral;
- (void)managerDisconnectPeripheral;
- (void)managerDiscoverServices:(NSArray<CBUUID *> * _Nullable)serviceUUIDs;
- (void)managerDiscoverCharacteristics:(NSArray<CBUUID *> * _Nullable)characteristicUUIDs for:(CBService * _Nonnull)service;
- (void)managerWriteValue:(NSData * _Nonnull)data for:(CBCharacteristic * _Nonnull)characteristic type:(CBCharacteristicWriteType)type;
- (void)managerSetNotifyValue:(BOOL)enabled for:(CBCharacteristic * _Nonnull)characteristic;
...
@class NSError;
SWIFT_PROTOCOL("_TtP10InnoHubSDK24BluetoothManagerDelegate_")
@protocol BluetoothManagerDelegate
@optional
- (void)managerDidUpdateStateWithState:(CBManagerState)state;
- (void)managerScanStateWithScanning:(BOOL)scanning;
- (void)managerDidDiscoverPeripheral:(CBCentralManager * _Nonnull)central didDiscover:(CBPeripheral * _Nonnull)peripheral advertisementData:(NSDictionary<NSString *, id> * _Nonnull)advertisementData rssi:(NSNumber * _Nonnull)RSSI;
- (void)managerDidDiscoverMorePeripheralWithAllPeripheral:(NSDictionary<NSUUID *, ZZPeripheral *> * _Nonnull)allPeripheral;
- (void)managerDidConnectPeripheralWithPeripheral:(CBPeripheral * _Nonnull)peripheral;
- (void)managerDidFailToConnectPeripheralWithPeripheral:(CBPeripheral * _Nonnull)peripheral error:(NSError * _Nullable)error;
- (void)managerDidDisconnectPeripheralWithPeripheral:(CBPeripheral * _Nonnull)peripheral error:(NSError * _Nullable)error;
- (void)peripheralDidDiscoverServicesWithServices:(NSArray<CBService *> * _Nonnull)services;
- (void)peripheralDidDiscoverCharacteristicsForServiceWithPeripheral:(CBPeripheral * _Nonnull)peripheral;
- (void)peripheralDidUpdateNotificationStateForCharacteristicWithCharacteristic:(CBCharacteristic * _Nonnull)characteristic;
- (void)peripheralDidUpdateValueForCharacteristicWithCharacteristic:(CBCharacteristic * _Nonnull)characteristic;
- (void)managerPeripheralWithPeripheral:(CBPeripheral * _Nonnull)peripheral characteristic:(CBCharacteristic * _Nonnull)characteristic error:(NSError * _Nullable)error;
@end
...
SWIFT_CLASS_NAMED("ZZPeripheral")
